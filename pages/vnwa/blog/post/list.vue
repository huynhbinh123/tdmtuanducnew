      ...
      <div class="flex items-center justify-end gap-4">
        ...
        <UButton  aria-label="Vinawebapp Button"  :loading="status === 'pending'" @click="refresh()" color="vnwa" label="Refresh"
          ...
          <NuxtLinkLocale  to="/vnwa/blog/post/create">
            ...
            <UButton  aria-label="Vinawebapp Button"  :loading="status === 'pending'" color="info" label="Create"
      ...
      <template #item-operation="{ id, name }">
        <div class="flex items-center justify-center gap-4 py-2">
          <NuxtLinkLocale :to="`/vnwa/blog/post/edit-${id}`">
            ...
            <UButton  aria-label="Vinawebapp Button"   size="sm" icon="heroicons:pencil-square" :label="$t('vnwa.edit')"
            color="warning" />
          </NuxtLinkLocale>
          <UButton  aria-label="Vinawebapp Button"  @click="deleteItem(id, name)" size="sm" icon="heroicons:trash" :label="$t('vnwa.remove')" color="error"
            variant="solid" />
        </div>
      </template>
