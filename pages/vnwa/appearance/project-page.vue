...
const { refresh, status: loadDataStatus } = await useHttp<any>("vnwa/appearance/project_page/load-data", {
  method: "GET",
  params: params,
  watch: [params],
  immediate: true,
...
const { refresh: formSubmit, status: appearanceUpdateStatus } = useHttp<any>("vnwa/appearance/project_page/update", {
  method: "POST",
  body: appearanceData,
  params: params,
  immediate: false,
