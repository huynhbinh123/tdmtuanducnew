  ...
  <div class="space-y-4">
    ...
    <UForm ref="form" :state="state" @submit="onSubmit" class="space-y-4">
      ...
      <div class="flex items-center justify-end space-x-4">
        <NuxtLinkLocale class="text-sm" to="/auth/forgot">Forgot your password?</NuxtLinkLocale>
    ...
    <div class="text-sm">
      ...
      <NuxtLinkLocale class="text-sm" to="/auth/register">Sign up now</NuxtLinkLocale>
    </div>
  </div>
</template>
