        ...
        <div class="lg:col-span-6 col-span-12  lg:text-left text-center  banner-left flex items-center h-full">
          <div class="banner-left-content   ">
            <div>
              ...
              <h5 class="text-lg  text-blue-900 uppercase mb-5">Vinawebapp.Com</h5>
            </div>
            <div>
              <h1 class="md:text-4xl  text-2xl font-mono font-bold md:mb-5 mb-3 text-white ">
                {{data.title}}
              </h1>
            </div>
            <div class="  ">
              <h3 class="md:text-xl whitespace-pre-line text-base text-gray-100/40   md:mb-5 mb-3  lg:pr-20  ">
                {{data.slogan}}
            ...
            <div class="flex lg:justify-start justify-center gap-4">
              <NuxtLinkLocale :to="'/'">
                <button
                  class=" text-white flex md:text-xl text-base w-full h-full mr-3 p-3 md:bg-red-500 bg-red-700  md:hover:bg-red-600 active:bg-red-600 uppercase md:hover:-translate-y-1">
                  <span> Start Project </span>
                  <UIcon name="mdi-light:arrow-right" color="white" class="ml-2  " />
                </button>
              </NuxtLinkLocale>
              <NuxtLinkLocale :to="'/'" class="button-array__button--secondary md:hover:-translate-y-1">
                <button
                  class=" flex md:text-xl text-base  text-white w-full h-full p-3 bg-gray-700 md:hover:bg-blue-600 active:bg-blue-600 uppercase ">
