<template>
  <div>
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-12 lg:col-span-3 h-full bg-slate-800">
        <div class="lg:sticky lg:top-24 ">
          ...
          <div class="bg-slate-800 rounded-sm  h-full  overflow-hidden ease-out  duration-300 lg:max-h-screen lg:py-4 max-h-0 py-0 px-2" :class="{ ' py-4 max-h-screen ': isHeadings }">
      ...
      <div class="col-span-12 lg:col-span-8 p-2">
        <div v-html="props.content" id="content" class="ck-content pb-20"></div>
  ...
  window.document
    ...
    .forEach(el => {
      if (el.innerText.trim()) {
        ...
        let id = slugify(el.innerText.replace(':', ''));
...
.headings_button>span:nth-child(1) {
  content: '';
  width: 19px;
  height: 4px;
  background: black;
...
.headings_button>span:nth-child(3) {
...
.headings_button>span:nth-child(2) {
...
.headings_button.active>span:nth-child(2) {
  background: purple;
  top: 28%;

}

.headings_button.active>span:nth-child(1) {
  background: purple;
  top: 47%;
  rotate: 45deg;
}

.headings_button.active>span:nth-child(3) {
  background: purple;
  top: 47%;
  rotate: -45deg;
}
