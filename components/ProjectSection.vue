        ...
        <UContainer>
            ...
            <div class="grid grid-cols-12 gap-4 w-full md:py-20 py-10">
                <div
                    ...
                    <div>
                        <h2 class="text-white font-semibold uppercase">Featured Projects</h2>
                        <NuxtLinkLocale to="/">
                            <h6
                ...
                <div class="xl:col-span-8 col-span-12 relative">
                    <div class="grid grid-cols-12 gap-4 w-full">
                        <div v-for="(item, index) in dataTopProject" :key="index"
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    <div :class="{ 'lg:col-span-6 lg:pr-20': index === 0, 'lg:col-span-12': index !== 0 }"
                                        ...
                                        <div class="lg:py-5 md:pr-3">
                                            <div class="md:pb-4 pb-2 text-blue-800 uppercase md:text-base text-sm">
                                                {{ item.cate_name }}
                                            </div>
                                            <h3 class="text-white font-header font-semibold pb-4 md:text-3xl text-xl">
                                                {{ item.name }}
                                                <Icon name="mdi-light:arrow-right" class="ml-2" />
                                            </h3>
                                    ...
                                    <div :class="{ 'lg:col-span-6 lg:order-first': index === 0, 'lg:col-span-12': index !== 0 }"
                                        class="col-span-12 flex justify-start items-center">
                                        <NuxtImg quality="80" format="webp" loading="lazy" width="100" height="100"
                                            :src="item.url_avatar"
                                            :srcset="item.url_avatar + ' 768w,' + item.url_avatar_mobile + ' 1200w'"
