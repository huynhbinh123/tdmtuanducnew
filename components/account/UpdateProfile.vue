...
<template>
  <UForm ref="form" :state="state" @submit="onSubmit" class="space-y-4">
    <UFormField label="" name="avatar" class="flex">
      <InputUploadImage v-model="state.avatar" accept=".png, .jpg, .jpeg, .webp" entity="avatars" max-size="5"
    ...
    <UAlert v-if="auth.user.must_verify_email" variant="outline" color="neutral"
      icon="i-heroicons-information-circle-20-solid" title="Please confirm your email address."
